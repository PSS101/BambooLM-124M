...
try:
    ...
    class Model(nn.Module):
        ...
        def save(self,i=None):
            ...
            if i is not None:
                torch.save(chk_point, os.path.join(check_point_dir,f"model_{i}.pt"))
                print("model saved at ", i)
            else:
                torch.save(chk_point, os.path.join(check_point_dir,"model.pt"))
                print("model saved")
    ...
    steps = int(total_tokens/total_batch)
    ...
    model.load(os.path.join(check_point_dir,"model.pt"))
